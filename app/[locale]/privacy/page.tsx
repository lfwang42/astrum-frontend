    ...
    return (
      <div className="min-h-screen container mx-auto py-10">
        <div className="flex flex-col min-w-2/3 mt-10 bg-slate-900 min-h-[200px] p-2">
          ...
          <p>This website collects your Star Rail data for ranking on leaderboards and profile display.  It collects no other personal information.</p>
          <br />
          ...
          <p>Wait 10 minutes and then refresh your profile.  Your data will be removed from the site.  If this process does not work, please contact @akodako on Discord.</p>
        </div>
      </div>
    );
  }